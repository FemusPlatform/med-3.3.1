...
SIZEOF_FORTRAN_INTEGERp4 = _medfamily.SIZEOF_FORTRAN_INTEGERp4
...
class MEDFLOAT32(_object):
    ...
    __repr__ = _swig_repr
    def iterator(self): return _medfamily.MEDFLOAT32_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _medfamily.MEDFLOAT32___nonzero__(self)
    def __bool__(self): return _medfamily.MEDFLOAT32___bool__(self)
    def __len__(self): return _medfamily.MEDFLOAT32___len__(self)
    def pop(self): return _medfamily.MEDFLOAT32_pop(self)
    def __getslice__(self, *args): return _medfamily.MEDFLOAT32___getslice__(self, *args)
    def __setslice__(self, *args): return _medfamily.MEDFLOAT32___setslice__(self, *args)
    def __delslice__(self, *args): return _medfamily.MEDFLOAT32___delslice__(self, *args)
    def __delitem__(self, *args): return _medfamily.MEDFLOAT32___delitem__(self, *args)
    def __getitem__(self, *args): return _medfamily.MEDFLOAT32___getitem__(self, *args)
    def __setitem__(self, *args): return _medfamily.MEDFLOAT32___setitem__(self, *args)
    def append(self, *args): return _medfamily.MEDFLOAT32_append(self, *args)
    def empty(self): return _medfamily.MEDFLOAT32_empty(self)
    def size(self): return _medfamily.MEDFLOAT32_size(self)
    def clear(self): return _medfamily.MEDFLOAT32_clear(self)
    def swap(self, *args): return _medfamily.MEDFLOAT32_swap(self, *args)
    def get_allocator(self): return _medfamily.MEDFLOAT32_get_allocator(self)
    def begin(self): return _medfamily.MEDFLOAT32_begin(self)
    def end(self): return _medfamily.MEDFLOAT32_end(self)
    def rbegin(self): return _medfamily.MEDFLOAT32_rbegin(self)
    def rend(self): return _medfamily.MEDFLOAT32_rend(self)
    def pop_back(self): return _medfamily.MEDFLOAT32_pop_back(self)
    def erase(self, *args): return _medfamily.MEDFLOAT32_erase(self, *args)
    def __init__(self, *args): 
        this = _medfamily.new_MEDFLOAT32(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args): return _medfamily.MEDFLOAT32_push_back(self, *args)
    def front(self): return _medfamily.MEDFLOAT32_front(self)
    def back(self): return _medfamily.MEDFLOAT32_back(self)
    def assign(self, *args): return _medfamily.MEDFLOAT32_assign(self, *args)
    def resize(self, *args): return _medfamily.MEDFLOAT32_resize(self, *args)
    def insert(self, *args): return _medfamily.MEDFLOAT32_insert(self, *args)
    def reserve(self, *args): return _medfamily.MEDFLOAT32_reserve(self, *args)
    def capacity(self): return _medfamily.MEDFLOAT32_capacity(self)
    def __iadd__(self, *args): return _medfamily.MEDFLOAT32___iadd__(self, *args)
    def __add__(self, *args): return _medfamily.MEDFLOAT32___add__(self, *args)
    def __isub__(self, *args): return _medfamily.MEDFLOAT32___isub__(self, *args)
    def __sub__(self, *args): return _medfamily.MEDFLOAT32___sub__(self, *args)
    def __imul__(self, *args): return _medfamily.MEDFLOAT32___imul__(self, *args)
    def __mul__(self, *args): return _medfamily.MEDFLOAT32___mul__(self, *args)
    def __idiv__(self, *args): return _medfamily.MEDFLOAT32___idiv__(self, *args)
    def __div__(self, *args): return _medfamily.MEDFLOAT32___div__(self, *args)
    def __le__(self, *args): return _medfamily.MEDFLOAT32___le__(self, *args)
    def __lt__(self, *args): return _medfamily.MEDFLOAT32___lt__(self, *args)
    def __gt__(self, *args): return _medfamily.MEDFLOAT32___gt__(self, *args)
    def __ge__(self, *args): return _medfamily.MEDFLOAT32___ge__(self, *args)
    def __eq__(self, *args): return _medfamily.MEDFLOAT32___eq__(self, *args)
    def __ne__(self, *args): return _medfamily.MEDFLOAT32___ne__(self, *args)
...
class MEDINT64(_object):
    ...
    __repr__ = _swig_repr
    def iterator(self): return _medfamily.MEDINT64_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _medfamily.MEDINT64___nonzero__(self)
    def __bool__(self): return _medfamily.MEDINT64___bool__(self)
    def __len__(self): return _medfamily.MEDINT64___len__(self)
    def pop(self): return _medfamily.MEDINT64_pop(self)
    def __getslice__(self, *args): return _medfamily.MEDINT64___getslice__(self, *args)
    def __setslice__(self, *args): return _medfamily.MEDINT64___setslice__(self, *args)
    def __delslice__(self, *args): return _medfamily.MEDINT64___delslice__(self, *args)
    def __delitem__(self, *args): return _medfamily.MEDINT64___delitem__(self, *args)
    def __getitem__(self, *args): return _medfamily.MEDINT64___getitem__(self, *args)
    def __setitem__(self, *args): return _medfamily.MEDINT64___setitem__(self, *args)
    def append(self, *args): return _medfamily.MEDINT64_append(self, *args)
    def empty(self): return _medfamily.MEDINT64_empty(self)
    def size(self): return _medfamily.MEDINT64_size(self)
    def clear(self): return _medfamily.MEDINT64_clear(self)
    def swap(self, *args): return _medfamily.MEDINT64_swap(self, *args)
    def get_allocator(self): return _medfamily.MEDINT64_get_allocator(self)
    def begin(self): return _medfamily.MEDINT64_begin(self)
    def end(self): return _medfamily.MEDINT64_end(self)
    def rbegin(self): return _medfamily.MEDINT64_rbegin(self)
    def rend(self): return _medfamily.MEDINT64_rend(self)
    def pop_back(self): return _medfamily.MEDINT64_pop_back(self)
    def erase(self, *args): return _medfamily.MEDINT64_erase(self, *args)
    def __init__(self, *args): 
        this = _medfamily.new_MEDINT64(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args): return _medfamily.MEDINT64_push_back(self, *args)
    def front(self): return _medfamily.MEDINT64_front(self)
    def back(self): return _medfamily.MEDINT64_back(self)
    def assign(self, *args): return _medfamily.MEDINT64_assign(self, *args)
    def resize(self, *args): return _medfamily.MEDINT64_resize(self, *args)
    def insert(self, *args): return _medfamily.MEDINT64_insert(self, *args)
    def reserve(self, *args): return _medfamily.MEDINT64_reserve(self, *args)
    def capacity(self): return _medfamily.MEDINT64_capacity(self)
    def __iadd__(self, *args): return _medfamily.MEDINT64___iadd__(self, *args)
    def __add__(self, *args): return _medfamily.MEDINT64___add__(self, *args)
    def __isub__(self, *args): return _medfamily.MEDINT64___isub__(self, *args)
    def __sub__(self, *args): return _medfamily.MEDINT64___sub__(self, *args)
    def __imul__(self, *args): return _medfamily.MEDINT64___imul__(self, *args)
    def __mul__(self, *args): return _medfamily.MEDINT64___mul__(self, *args)
    def __idiv__(self, *args): return _medfamily.MEDINT64___idiv__(self, *args)
    def __div__(self, *args): return _medfamily.MEDINT64___div__(self, *args)
    def __le__(self, *args): return _medfamily.MEDINT64___le__(self, *args)
    def __lt__(self, *args): return _medfamily.MEDINT64___lt__(self, *args)
    def __gt__(self, *args): return _medfamily.MEDINT64___gt__(self, *args)
    def __ge__(self, *args): return _medfamily.MEDINT64___ge__(self, *args)
    def __eq__(self, *args): return _medfamily.MEDINT64___eq__(self, *args)
    def __ne__(self, *args): return _medfamily.MEDINT64___ne__(self, *args)
