...
class MEDINT32(_object):
    ...
    __repr__ = _swig_repr
    def iterator(self): return _medfamily.MEDINT32_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _medfamily.MEDINT32___nonzero__(self)
    def __bool__(self): return _medfamily.MEDINT32___bool__(self)
    def __len__(self): return _medfamily.MEDINT32___len__(self)
    def pop(self): return _medfamily.MEDINT32_pop(self)
    def __getslice__(self, *args): return _medfamily.MEDINT32___getslice__(self, *args)
    def __setslice__(self, *args): return _medfamily.MEDINT32___setslice__(self, *args)
    def __delslice__(self, *args): return _medfamily.MEDINT32___delslice__(self, *args)
    def __delitem__(self, *args): return _medfamily.MEDINT32___delitem__(self, *args)
    def __getitem__(self, *args): return _medfamily.MEDINT32___getitem__(self, *args)
    def __setitem__(self, *args): return _medfamily.MEDINT32___setitem__(self, *args)
    def append(self, *args): return _medfamily.MEDINT32_append(self, *args)
    def empty(self): return _medfamily.MEDINT32_empty(self)
    def size(self): return _medfamily.MEDINT32_size(self)
    def clear(self): return _medfamily.MEDINT32_clear(self)
    def swap(self, *args): return _medfamily.MEDINT32_swap(self, *args)
    def get_allocator(self): return _medfamily.MEDINT32_get_allocator(self)
    def begin(self): return _medfamily.MEDINT32_begin(self)
    def end(self): return _medfamily.MEDINT32_end(self)
    def rbegin(self): return _medfamily.MEDINT32_rbegin(self)
    def rend(self): return _medfamily.MEDINT32_rend(self)
    def pop_back(self): return _medfamily.MEDINT32_pop_back(self)
    def erase(self, *args): return _medfamily.MEDINT32_erase(self, *args)
    def __init__(self, *args): 
        this = _medfamily.new_MEDINT32(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args): return _medfamily.MEDINT32_push_back(self, *args)
    def front(self): return _medfamily.MEDINT32_front(self)
    def back(self): return _medfamily.MEDINT32_back(self)
    def assign(self, *args): return _medfamily.MEDINT32_assign(self, *args)
    def resize(self, *args): return _medfamily.MEDINT32_resize(self, *args)
    def insert(self, *args): return _medfamily.MEDINT32_insert(self, *args)
    def reserve(self, *args): return _medfamily.MEDINT32_reserve(self, *args)
    def capacity(self): return _medfamily.MEDINT32_capacity(self)
    def __iadd__(self, *args): return _medfamily.MEDINT32___iadd__(self, *args)
    def __add__(self, *args): return _medfamily.MEDINT32___add__(self, *args)
    def __isub__(self, *args): return _medfamily.MEDINT32___isub__(self, *args)
    def __sub__(self, *args): return _medfamily.MEDINT32___sub__(self, *args)
    def __imul__(self, *args): return _medfamily.MEDINT32___imul__(self, *args)
    def __mul__(self, *args): return _medfamily.MEDINT32___mul__(self, *args)
    def __idiv__(self, *args): return _medfamily.MEDINT32___idiv__(self, *args)
    def __div__(self, *args): return _medfamily.MEDINT32___div__(self, *args)
    def __le__(self, *args): return _medfamily.MEDINT32___le__(self, *args)
    def __lt__(self, *args): return _medfamily.MEDINT32___lt__(self, *args)
    def __gt__(self, *args): return _medfamily.MEDINT32___gt__(self, *args)
    def __ge__(self, *args): return _medfamily.MEDINT32___ge__(self, *args)
    def __eq__(self, *args): return _medfamily.MEDINT32___eq__(self, *args)
    def __ne__(self, *args): return _medfamily.MEDINT32___ne__(self, *args)
